  ...
  return (
    <>
      ...
      <Markdown>
        ...
        있습니다. 선택 된 App들의 Line, Branch Coverage와 Pass Rate 및 최근 빌드
        시간을 확인할 수 있습니다.
      </Markdown>
      ...
      <Markdown>
        ...
        있습니다. App Name과 Git Repository URL을 입력하면 자동으로 해당
        프로젝트에 속한 App이 생성되며 이후 해당 App의 빌드 결과를 확인할 수
        있습니다.
      </Markdown>
      ...
      <Markdown>
        ...
        있습니다. 해당 화면에서 Covage 또는 Pass Rate 열을 클릭하면 해당 이력의
        상세 내용을 확인할 수 있습니다.
      </Markdown>
